...
CREATE TABLE IF NOT EXISTS users (
    ...
    refresh_session_epoch BIGINT NOT NULL DEFAULT 1,
...
-- Cross-JVM ordering fence for all projections of one post.
...
-- Durable completion fact for all idempotent post projections.
